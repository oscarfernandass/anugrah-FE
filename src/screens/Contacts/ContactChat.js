  ...
  const sendTextOrImageMessage = async () => {
    ...
    if (textToSend || imageToSend) {
      ...
      const block={
        ...
        receiver_phone:userPhoneNumber,
      ...
      try {
        ...
        const response=postBlock(block);
      ...
      <KeyboardAvoidingView style={[styles.container]} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
        <ImageBackground source={back} style={styles.container}>
          ...
          </LinearGradient>
          {
            audioVisible && (
              <View>
                <AudioCall lang={langer} callID={callID} numberu={userPhoneNumber} onTextReceived={handleTextReceived} onEndCall={handleEndAudioCall} />
              </View>
            )
          }

          {
            ...
            videoVisible && (
              <View>
                <VideoCall lang={langer} callID={callID} numberu={userPhoneNumber} onTextReceived={handleTextReceived} onEndCall={handleEndVideoCall} />
              </View>
            )
          }
          <FlatList
