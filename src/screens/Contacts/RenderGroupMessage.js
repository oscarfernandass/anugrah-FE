...
const RenderGroupMessage = ({ item, senderPhoneNumber, route, playAudio, voiceplay, chatPath }) => {
        ...
        <>
            ...
            >
                ...
                {item.base64Image ? (
                    ...
                    <TouchableWithoutFeedback onPress={handleDoubleTap}>
                        {/* {item.sender!==senderPhoneNumber&&(
                <Text style={[{color:'black'},styles.receiverText]}>{item?.myName}</Text>
            )} */}
                        <Text
                            style={[
                                styles.messageText,
                        ...
                        >
                            <Text style={{ color: 'black',fontWeight:'600', fontSize:15, backgroundColor:'white',padding:2 }}>{item.myName}</Text> --{item.text}
                        </Text>
...
export default RenderGroupMessage;
