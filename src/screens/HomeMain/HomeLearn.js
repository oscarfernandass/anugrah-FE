    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={{ paddingLeft: 20, marginTop: 17 }}>
        ...
        <View style={{ marginTop: 8, flexWrap: 'wrap', width: '100%', flexDirection: 'row', gap: 22 }}>
          ...
          <TouchableOpacity onPress={()=>{
          ...
          }} style={{ flexDirection: 'column', gap: 3, justifyContent: 'center', alignItems: 'center' }}>
            ...
            <Text style={[{ color: 'black', fontSize: 12, fontWeight: '400' }, styles.font]}>Text to sign</Text>
          </TouchableOpacity>
