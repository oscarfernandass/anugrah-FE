...
const LangCon = () => {
    ...
    const fetchLanguage = async () => {
        try {
            const savedLanguage = await AsyncStorage.getItem('selected2');
            if (savedLanguage) {
    ...
    const handleFixLanguage = async () => {
        try {
            ...
            await AsyncStorage.setItem('selectedLanguage2', englishForm); // Save the English form
            await AsyncStorage.setItem('selected2', currentSelection); // Save the English form
            ToastAndroid.show(
